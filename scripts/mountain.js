    ...
    if (mountain) {
      mountainInfoContainer.innerHTML = `
        <div class="result-box">
          <h3>${mountain.name}</h3>
          <table class="glass" border="1" style="width: 100%; border-collapse: collapse; margin-bottom: 10px;">
            <tr>
          ...
          <table id="sunrise-sunset-table" class="glass" border="1" style="width: 100%; border-collapse: collapse; margin-top: 10px;">
            <tr>
